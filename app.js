...
function render() {
    ...
    app.innerHTML = `
        ...
        <button class="btn" onclick="callWaiter()" style="position: fixed; bottom: 24px; left: 24px; background: var(--accent); color: var(--text-dark); border-radius: 50%; width: 56px; height: 56px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); z-index: 100; display: flex; align-items: center; justify-content: center;">
